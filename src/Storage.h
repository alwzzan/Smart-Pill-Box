...
public:
    ...
    /**
     * @brief Save lid opening count
     * @param count Number of openings today
     */
    void saveLidOpenings(uint16_t count);
    
    /**
     * @brief Load lid opening count
     * @return Saved opening count
     */
    uint16_t loadLidOpenings();
