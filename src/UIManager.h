...
public:
    ...
    void displayHome(Time12H time, int16_t minutesToNextDose, 
                     ...
                     bool wifiOn, bool muteOn, uint16_t lidOpenings = 0);
     ...
     * @param titleOverride Optional custom title (e.g., "SET TIME")
     */
    void displayDoseEdit(Time12H time, uint8_t editField, bool isNew, const char* titleOverride = nullptr);
